...
class WebTestCase(SilentLogMixin, IsolatedAsyncioTestCase):
    ...
    @patch.object(web, "content_type_for_extension")
    ...
    def test_serve_file_via_x_accel(
        ...
        mock_content_type_for_extension: MagicMock,
    ) -> None:
        ...
        mock_content_type_for_extension.return_value = content = "video/mp4"
        ...
        mock_content_type_for_extension.assert_called_once_with(file_suffixes)
